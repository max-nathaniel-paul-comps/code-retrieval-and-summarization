...
class UTDecoder(tf.keras.layers.Layer):
    ...
    def call(self, x, enc_output, training,
        ...
        for t in range(self.num_layers):
            ...
            attention_weights['decoder_layer{}_block1'.format(t + 1)] = block1
            attention_weights['decoder_layer{}_block2'.format(t + 1)] = block2
...
def main(model_path="../models/transformer_6/", train=True):
    ...
    language_seqifier = Tokenizer(seqifiers_description['language_seq_type'],
    ...
    code_seqifier = Tokenizer(seqifiers_description['source_code_seq_type'],
    ...
    target_vocab_size = language_seqifier.vocab_size
    dropout_rate = 0.1

    transformer = Transformer(num_layers, d_model, num_heads, dff,
                              input_vocab_size, target_vocab_size,
                              input_vocab_size, target_vocab_size,
                              model_path, code_seqifier, language_seqifier,
                              rate=dropout_rate)
